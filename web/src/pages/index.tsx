...
export default function Home(props: HomeProps) {
  ...
  return (
   <div className='max-w-[1124px] mt-11 h-screen mx-auto grid grid-cols-2 gap-28 items-center'>
    <main>
    ...
    >Após criar seu bolão, você receberá um código único que poderá usar para convidar seus amigos.</p>
    ...
    <Image quality={100} src={appPreviewImg} alt="Preview do app da copa" />
   </div>
  )
}
